...
use bendclaw::kernel::run::execution::llm::assistant_turn::aborted_tool_result_messages;
use bendclaw::kernel::run::execution::llm::assistant_turn::assistant_message_from_turn;
use bendclaw::kernel::run::execution::llm::assistant_turn::record_assistant_turn;
...
fn record_assistant_turn_without_tool_calls_sets_final_content() {
    ...
    match &state.final_content()[1] {
        bendclaw::kernel::run::ContentBlock::Text { text } => assert_eq!(text, "final answer"),
