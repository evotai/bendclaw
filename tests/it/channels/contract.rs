...
use bendclaw::channels::ChannelPlugin;
use bendclaw::channels::InboundKind;
...
use bendclaw::channels::adapters::feishu::FeishuChannel;
use bendclaw::channels::adapters::github::GitHubChannel;
use bendclaw::channels::adapters::http_api::HttpApiChannel;
use bendclaw::channels::adapters::telegram::TelegramChannel;
