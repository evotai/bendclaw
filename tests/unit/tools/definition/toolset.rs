...
use bendclaw::tools::selection::build_local_toolset;
use bendclaw::tools::tool_services::NoopSecretUsageSink;

fn sink() -> Arc<dyn bendclaw::tools::tool_services::SecretUsageSink> {
    Arc::new(NoopSecretUsageSink)
}

fn make_local_toolset() -> bendclaw::tools::definition::toolset::Toolset {
