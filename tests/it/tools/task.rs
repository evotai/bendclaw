...
use anyhow::Result;
use bendclaw::tools::tasks::task_create::TaskCreateTool;
use bendclaw::tools::tasks::task_delete::TaskDeleteTool;
use bendclaw::tools::tasks::task_get::TaskGetTool;
use bendclaw::tools::tasks::task_history::TaskHistoryTool;
use bendclaw::tools::tasks::task_list::TaskListTool;
use bendclaw::tools::tasks::task_toggle::TaskToggleTool;
use bendclaw::tools::tasks::task_update::TaskUpdateTool;
...
fn test_ctx() -> bendclaw::tools::ToolContext {
    bendclaw::tools::ToolContext {
        user_id: "u1".into(),
        session_id: "s1".into(),
        agent_id: "a1".into(),
        run_id: "r-test".into(),
