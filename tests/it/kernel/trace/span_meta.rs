...
#[test]
fn span_meta_llm_turn_to_json_contains_iteration() -> Result<()> {
...
#[test]
fn span_meta_llm_result_to_json_contains_finish_reason() -> Result<()> {
...
#[test]
fn span_meta_llm_completed_to_json_contains_tokens() -> Result<()> {
...
#[test]
fn span_meta_llm_failed_to_json_contains_error() -> Result<()> {
...
#[test]
fn span_meta_tool_started_to_json_contains_tool_call_id() -> Result<()> {
...
#[test]
fn span_meta_tool_completed_to_json_no_impact_field_when_none() -> Result<()> {
...
#[test]
fn span_meta_tool_completed_to_json_has_impact_when_some() -> Result<()> {
    let meta = SpanMeta::ToolCompleted {
...
#[test]
fn span_meta_tool_failed_to_json_contains_error() -> Result<()> {
...
#[test]
fn span_meta_empty_to_json_is_object() -> Result<()> {
