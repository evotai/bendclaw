...
#[test]
fn delta_from_content_delta() {
    let event = StreamEvent::ContentDelta("hello".into());
    let delta = Delta::from_stream_event(&event).unwrap();
    match delta {
...
fn delta_from_tool_call_start() {
    ...
    match delta {
        ...
        _ => panic!("expected ToolCallStart delta"),
    }
}

#[test]
fn delta_from_tool_call_delta() {
...
fn delta_from_usage() {
    ...
    match delta {
        ...
        _ => panic!("expected Usage delta"),
    }
}

#[test]
fn delta_from_done_contains_provider_and_model() {
    let event = StreamEvent::Done {
        finish_reason: "stop".into(),
        provider: Some("openai".into()),
        model: Some("gpt-4.1-mini".into()),
    };
    let delta = Delta::from_stream_event(&event);
    match delta {
        Some(Delta::Done {
            finish_reason,
            provider,
...
#[test]
fn event_start_serde_roundtrip() {
    let e = Event::Start;
...
#[test]
fn event_aborted_serde_roundtrip() {
    let e = Event::Aborted {
...
#[test]
fn event_compaction_done_serde() {
    ...
    match back {
        ...
        _ => panic!("expected CompactionDone"),
    }
}
...
#[test]
fn delta_serde_roundtrip_thinking() {
...
#[test]
fn delta_serde_roundtrip_tool_call_start() {
...
#[test]
fn delta_serde_roundtrip_tool_call_delta() {
...
#[test]
fn delta_serde_roundtrip_tool_call_end() {
...
#[test]
fn delta_serde_roundtrip_done_no_provider() {
    let d = Delta::Done {
...
fn event_reason_end_serde() {
    ...
    match back {
        ...
        _ => panic!("expected ReasonEnd"),
    }
}

#[test]
fn event_reason_error_serde() {
    ...
    match back {
        ...
        _ => panic!("expected ReasonError"),
    }
}

#[test]
fn event_tool_start_serde() {
...
#[test]
fn event_checkpoint_done_serde() {
    ...
    match back {
        ...
        _ => panic!("expected CheckpointDone"),
    }
}

#[test]
fn event_app_data_serde() {
