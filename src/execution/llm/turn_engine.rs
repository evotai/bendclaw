...
use crate::execution::hooks::TurnDecision;
use crate::execution::result::ContentBlock;
...
pub struct Engine {
    pub(in crate::execution) ctx: Context,
    pub(in crate::execution) compactor: Compactor,
    pub(in crate::execution) orchestrator: ToolOrchestrator,
    pub(in crate::execution) cancel: CancellationToken,
    pub(in crate::execution) iteration: Arc<AtomicU32>,
    pub(in crate::execution) tx: mpsc::Sender<Event>,
    pub(in crate::execution) trace: Trace,
    pub(in crate::execution) abort_policy: AbortPolicy,
    pub(in crate::execution) inbox: mpsc::Receiver<Message>,
    pub(in crate::execution) loop_span_id: String,
    pub(in crate::execution) latest_checkpoint: Option<CompactionCheckpoint>,
    pub(in crate::execution) memory: Option<Arc<MemoryService>>,
    pub(in crate::execution) before_turn_hook: Option<Box<dyn BeforeTurnHook>>,
    pub(in crate::execution) steering_source: Option<Box<dyn SteeringSource>>,
}
...
impl Engine {
    ...
    pub(in crate::execution) async fn emit(&self, event: Event) {
        let _ = self.tx.send(event).await;
    }

    pub(in crate::execution) fn ops_ctx(&self, turn: u32) -> server_log::ServerCtx<'_> {
    ...
    pub(in crate::execution) fn audit_payload(
        &self,
        turn: u32,
    ...
    pub(in crate::execution) async fn emit_audit(
        &self,
        name: &str,
