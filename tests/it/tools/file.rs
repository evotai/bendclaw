use bendclaw::tools::filesystem::FileEditTool;
use bendclaw::tools::filesystem::FileReadTool;
use bendclaw::tools::filesystem::FileWriteTool;
use bendclaw::tools::Tool;
use serde_json::json;

use crate::mocks::context::test_workspace;

fn make_ctx(workspace_dir: std::path::PathBuf) -> bendclaw::tools::ToolContext {
    use ulid::Ulid;
