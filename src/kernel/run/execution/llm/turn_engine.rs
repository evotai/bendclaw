...
use crate::kernel::run::execution::tools::ToolOrchestrator;
...
pub struct Engine {
    pub(in crate::kernel::run::execution) ctx: Context,
    pub(in crate::kernel::run::execution) compactor: Compactor,
    pub(in crate::kernel::run::execution) orchestrator: ToolOrchestrator,
    pub(in crate::kernel::run::execution) cancel: CancellationToken,
    pub(in crate::kernel::run::execution) iteration: Arc<AtomicU32>,
    pub(in crate::kernel::run::execution) tx: mpsc::Sender<Event>,
    pub(in crate::kernel::run::execution) trace: Trace,
    pub(in crate::kernel::run::execution) abort_policy: AbortPolicy,
    pub(in crate::kernel::run::execution) inbox: mpsc::Receiver<Message>,
    pub(in crate::kernel::run::execution) loop_span_id: String,
    pub(in crate::kernel::run::execution) latest_checkpoint: Option<CompactionCheckpoint>,
    pub(in crate::kernel::run::execution) memory: Option<Arc<MemoryService>>,
    pub(in crate::kernel::run::execution) before_turn_hook: Option<Box<dyn BeforeTurnHook>>,
    pub(in crate::kernel::run::execution) steering_source: Option<Box<dyn SteeringSource>>,
}
...
impl Engine {
    ...
    pub(in crate::kernel::run::execution) async fn emit(&self, event: Event) {
        let _ = self.tx.send(event).await;
    }

    pub(in crate::kernel::run::execution) fn ops_ctx(
        &self,
        turn: u32,
    ) -> server_log::ServerCtx<'_> {
    ...
    pub(in crate::kernel::run::execution) fn audit_payload(
        &self,
        turn: u32,
    ...
    pub(in crate::kernel::run::execution) async fn emit_audit(
        &self,
        name: &str,
