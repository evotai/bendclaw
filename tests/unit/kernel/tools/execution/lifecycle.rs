//! Tests for ToolLifecycle — verifies the execution boundary contracts:
...
use bendclaw::kernel::tools::execution::dispatch::tool_events::EventEmitter;
use bendclaw::kernel::tools::execution::dispatch::tool_recorder::ExecutionRecorder;
use bendclaw::kernel::tools::execution::dispatch::CallExecutor;
use bendclaw::kernel::tools::execution::dispatch::ToolLifecycle;
...
fn build_lifecycle(tools: Vec<Arc<dyn Tool>>) -> (ToolLifecycle, mpsc::Receiver<Event>) {
    ...
    (ToolLifecycle::new(executor, recorder, emitter), rx)
}
