...
use bendclaw::channels::adapters::feishu::message::parse_event;
use bendclaw::channels::adapters::feishu::message::parse_post;
use bendclaw::channels::adapters::feishu::message::should_respond_in_group;
use bendclaw::channels::adapters::feishu::message::strip_at_placeholders;
use bendclaw::channels::adapters::feishu::message::MessageDedup;
use bendclaw::channels::adapters::feishu::FeishuConfig;
...
fn parse_event_text_message() {
    ...
    if let Some(bendclaw::channels::InboundEvent::Message(m)) = result {
