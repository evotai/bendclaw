...
Thanks to [open-agent-sdk-rust](https://github.com/codeany-ai/open-agent-sdk-rust) for the clean Rust agent runtime ideas that helped shape BendClaw's redesign direction.
