...
use bendclaw::tools::web::cache::WebCache;
use bendclaw::tools::web::SearchProvider;
use bendclaw::tools::web::WebFetchTool;
use bendclaw::tools::web::WebSearchTool;
...
async fn web_search_success_formats_results_and_caps_count(
    ...
    let noop_sink: Arc<dyn bendclaw::tools::tool_services::SecretUsageSink> =
    ...
    let ctx = bendclaw::tools::ToolContext {
        user_id: "u1".into(),
        session_id: "s1".into(),
        agent_id: "a1".into(),
        run_id: "r-test".into(),
...
fn ddg_parse_results_extracts_title_url_snippet() {
    ...
    "#;
    let results = bendclaw::tools::web::duckduckgo::parse_results_for_test(html, 10);
...
fn ddg_parse_results_respects_max_count() {
    ...
    "#;
    let results = bendclaw::tools::web::duckduckgo::parse_results_for_test(html, 2);
