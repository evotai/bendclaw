...
fn build_cloud_entries(deps: &CloudToolsetDeps) -> Vec<ToolEntry> {
    ...
    use crate::kernel::tools::builtin::skills::skill_create::SkillCreateTool;
    use crate::kernel::tools::builtin::skills::skill_read::SkillReadTool;
    use crate::kernel::tools::builtin::skills::skill_remove::SkillRemoveTool;
    use crate::kernel::tools::builtin::tasks::task_create::TaskCreateTool;
    use crate::kernel::tools::builtin::tasks::task_delete::TaskDeleteTool;
    use crate::kernel::tools::builtin::tasks::task_get::TaskGetTool;
    use crate::kernel::tools::builtin::tasks::task_history::TaskHistoryTool;
    use crate::kernel::tools::builtin::tasks::task_list::TaskListTool;
    use crate::kernel::tools::builtin::tasks::task_run::TaskRunTool;
    use crate::kernel::tools::builtin::tasks::task_toggle::TaskToggleTool;
    use crate::kernel::tools::builtin::tasks::task_update::TaskUpdateTool;
...
fn build_optional_entries(
    ...
    if let Some((service, dispatch_table)) = cluster {
        use crate::kernel::tools::builtin::cluster::cluster_collect::ClusterCollectTool;
        use crate::kernel::tools::builtin::cluster::cluster_dispatch::ClusterDispatchTool;
        use crate::kernel::tools::builtin::cluster::cluster_nodes::ClusterNodesTool;
    ...
    if let Some(mem) = memory {
        use crate::kernel::tools::builtin::memory::memory_save::MemorySaveTool;
        use crate::kernel::tools::builtin::memory::memory_search::MemorySearchTool;
