...
#[async_trait]
impl bendclaw::kernel::skills::execution::SkillExecutor for NoopSkillExecutor {
    async fn execute(
        &self,
        _skill_name: &str,
        _args: &[String],
    ) -> bendclaw::base::Result<bendclaw::kernel::skills::execution::SkillOutput> {
        Ok(bendclaw::kernel::skills::execution::SkillOutput {
            data: None,
