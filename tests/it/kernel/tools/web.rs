...
use axum::Router;
use bendclaw::kernel::tools::builtin::web::SearchProvider;
use bendclaw::kernel::tools::builtin::web::WebFetchTool;
use bendclaw::kernel::tools::builtin::web::WebSearchTool;
...
async fn web_search_success_formats_results_and_caps_count(
    ...
    let noop_sink: Arc<dyn bendclaw::kernel::tools::tool_services::SecretUsageSink> =
